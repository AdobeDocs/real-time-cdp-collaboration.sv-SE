...
* Konfigurera {#setup}
   ...
   * Source och hantera målgrupper {#source-audiences}
      ...
      * [Konfigurera Snowflake för målgruppskälla](./setup/configure-snowflake-audience-sourcing.md)
   ...
   * [Hantera anslutning till mätdata](./setup/manage-measurement-data-connection.md)
