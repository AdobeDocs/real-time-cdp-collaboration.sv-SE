...
>abstract="<p>Anger vilka av målgruppens metadata som är synliga för andra medarbetare innan de ansluter till dig eller inom projektvyer.</p> <p> **Identitetsantal** kontrollerar om din medarbetare kan visa identitetsantal för dina målgrupper när de visar överlappningsrapporter på fliken Identifiering. **Målgruppen överlappar %** kontrollerar om medarbetare kan identifiera överlappande procentandelar mellan sina målgrupper och dina."
