...
Real-Time CDP Collaboration har nu stöd för CSV-filöverföring som en ny metod för att hämta målgrupper och nya mobilmatchningsnycklar (IDFA och GAID) för förbättrad målgruppsmatchning och mätning.

**Nya eller uppdaterade funktioner**

| Funktion | Beskrivning |
| ------- | ----------- |
| CSV-överföring för målgruppskälla | Överför CSV-filer till källgrupper i Collaboration direkt från användargränssnittet. Idealiskt för introduktion av förstahandsdata för kortvariga samarbetsprojekt. Mer information finns i [överförings-CSV-filen för målgruppsguiden](../setup/upload-csv-audience-sourcing.md). |
| Stöd för Mobile Match Key | Collaboration har nu stöd för matchningsnycklar för mobiler, inklusive IDFA och GAID, för målgruppsmatchning och mätning. Dessa matchningsnycklar väljs under kontokonfiguration och kan sedan användas när anslutningsinställningar konfigureras för nya anslutningar och i arbetsflöden för samarbete längre fram i kedjan. Mer information finns i [Installationsguiden för Matcha nycklar](../setup/onboard-account.md#set-up-match-keys). |

{style="table-layout:auto"}

## December 2025 {#december-2025}

Real-Time CDP Collaboration är nu tillgängligt för kunder i **Europa, Mellanöstern och Afrika (EMEA)**. Det är automatiskt tillgängligt för kunder som har Real-Time CDP Prime och Ultimate i dessa länder.
